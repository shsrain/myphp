...
<title>404 访问发生错误 - 对不起，您访问的页面不存在</title>
<style type="text/css">
...
<body>
	...
	<p class="link">
		<span style="color:#C22435;"><?php echo $e['message'];?>&nbsp;&nbsp; </span>您可以选择
    </p>	
	<p class="link">
		<a href="<?php echo (strip_tags($_SERVER['REQUEST_URI']));?>">&#9666;重试</a>
        <a href="javascript:history.back();">&#9666;返回上一页</a>
		<a href="<?php echo(__APP__);?>">&#9666;回到首页</a>
    </p>
    <dl class="texts">
